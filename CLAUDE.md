...
was WRITTEN: 127 repository files / 131 live history rows / TWO unapplied —
Moyasar (frozen on purpose) and `20260913120000` (written, awaiting approval).**
Latest live version is still `20260909073209` (ledger row 86); nothing has been
applied since.
