...
const ADMIN_MIGRATED = [
  ...
  'src/components/admin/view/stats/BranchAvailability.tsx',
  'src/components/admin/view/stats/BranchSalesSection.tsx',
  'src/components/admin/view/stats/BranchSalesTable.tsx',
  'src/components/admin/view/stats/branchSales.ts',
  'src/components/admin/view/stats/statsCopy.ts',
