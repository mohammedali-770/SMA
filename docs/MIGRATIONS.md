...
> **Updated 2026-09-14 (latest) — `20260921120000_loyalty_earn_snapshot_path`
> is APPLIED. The count is THREE.** Outstanding: Moyasar (frozen under §6),
> `20260919120000_security_audit_db_hardening` and
> `20260920120000_promo_disclosure_hardening`. Moyasar still sorts ahead of
> everything — **name the target by version**.
>
> Live read after the apply: **135 repository files / 138 live history rows**,
