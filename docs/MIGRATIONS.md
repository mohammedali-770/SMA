...
>
> **X3 is not closed by that apply.** It was step 1 of four, and the deploy
> (step 2) followed the same day — `operations-alert-dispatch` version 1,
> 2026-09-07 07:18:43 UTC. The scheduler apply with its two Vault secrets and the
> flag are two further §5 actions. Until all four, `INCIDENT_RESPONSE.md` §1b's
> named watcher is the real answer.
>
