...
(§28), `branch_availability_retention` (§30), and the `noop` probe. Rows 57–60
are appended out of that sequence: 57–58 because §1 now turns on them, 59–60
because they are the most recent applications (2026-08-25, §32).
