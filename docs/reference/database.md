...
Migration files in the repository: **95**. Earliest `20260707120000_extensions_enums_helpers.sql`, latest `20260820160000_branch_availability_health_card.sql`.
...
| `order_items` | `20260707120500_orders.sql` | 0 | 2 |
...
| `compute_order_snapshot` | 1 | `20260712160000_checkout_sessions.sql` |
...
| `insert_order_from_snapshot` | 2 | `20260712170000_checkout_sessions_hardening.sql` |
...
| `place_order` | 8 | `20260820140500_place_order_modifier_availability.sql` |
