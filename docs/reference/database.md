...
Migration files in the repository: **83**. Earliest `20260707120000_extensions_enums_helpers.sql`, latest `20260821170000_order_item_notes.sql`.
...
| `branch_product_availability` | `20260707120200_catalog.sql` | 0 | 1 |
| `branches` | `20260707120200_catalog.sql` | 2 | 3 |
...
| `operations_alerts_render_event` | 2 | `20260807170000_order_flow_alert_condition.sql` |
...
| `operations_health_snapshot_internal` | 3 | `20260807150000_order_flow_health_card.sql` |
...
| `place_order` | 8 | `20260821170000_order_item_notes.sql` |
