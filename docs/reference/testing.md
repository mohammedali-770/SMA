...
**141 TypeScript test files declaring 1996 test blocks, plus 52 SQL suites.**
...
12 files, 223 declared test blocks.
...
| `supabase/functions/_shared/adminAuthWiring.test.ts` | 9 | staff-accounts privileged actions |
