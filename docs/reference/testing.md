...
**154 TypeScript test files declaring 2387 test blocks, plus 60 SQL suites.**
...
16 files, 477 declared test blocks.
...
| `supabase/functions/_shared/orderIntakeSyncWiring.test.ts` | 27 | order-intake — immediate POS sync, and no premature promise |
