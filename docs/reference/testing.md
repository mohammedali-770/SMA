...
**119 TypeScript test files declaring 1669 test blocks, plus 44 SQL suites.**
...
49 files, 704 declared test blocks.
...
| `apps/mobile/src/features/order/orderNote.test.ts` | 15 | checkOrderNote |
