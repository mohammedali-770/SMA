...
**145 TypeScript test files declaring 2171 test blocks, plus 53 SQL suites.**
...
74 files, 982 declared test blocks.
...
| `src/components/StaffMfaGate.test.tsx` | 10 | StaffMfaGate |
