...
**156 TypeScript test files declaring 2434 test blocks, plus 60 SQL suites.**
...
18 files, 524 declared test blocks.
...
| `supabase/functions/_shared/orderIntakeSyncWiring.test.ts` | 33 | order-intake — immediate POS sync, and no premature promise |
| `supabase/functions/_shared/rest.test.ts` | 36 | cleanSelect — whitespace stripped exactly as postgrest-js stripped it |
