...
**145 TypeScript test files declaring 2154 test blocks, plus 53 SQL suites.**
...
14 files, 368 declared test blocks.
...
| `supabase/functions/_shared/moyasar.test.ts` | 81 | minor units (halalas) |
