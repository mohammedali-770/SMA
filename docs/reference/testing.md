...
**164 TypeScript test files declaring 2512 test blocks, plus 62 SQL suites.**
...
22 files, 570 declared test blocks.
...
| `supabase/functions/_shared/alertDispatchWiring.test.ts` | 15 | operations-alert-dispatch is inert until deliberately enabled |
