...
**164 TypeScript test files declaring 2509 test blocks, plus 62 SQL suites.**
...
22 files, 567 declared test blocks.
...
| `supabase/functions/_shared/alertDispatchWiring.test.ts` | 12 | operations-alert-dispatch is inert until deliberately enabled |
