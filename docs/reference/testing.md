...
**199 TypeScript test files declaring 3153 test blocks, plus 80 SQL suites.**
...
70 files, 1003 declared test blocks.
...
| `apps/mobile/src/features/menu/categoryFocus.test.ts` | 13 | categoryFocusReducer |
