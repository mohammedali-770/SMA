...
**154 TypeScript test files declaring 2384 test blocks, plus 60 SQL suites.**
...
16 files, 474 declared test blocks.
...
| `supabase/functions/_shared/orderIntakeSyncWiring.test.ts` | 24 | order-intake — immediate POS sync, and no premature promise |
