...
**151 TypeScript test files declaring 2315 test blocks, plus 59 SQL suites.**
...
16 files, 454 declared test blocks.
...
| `supabase/functions/_shared/orderIntakeSyncWiring.test.ts` | 4 | order-intake — immediate POS sync wiring |
