...
**154 TypeScript test files declaring 2385 test blocks, plus 60 SQL suites.**
...
16 files, 475 declared test blocks.
...
| `supabase/functions/_shared/orderIntakeSyncWiring.test.ts` | 25 | order-intake — immediate POS sync, and no premature promise |
