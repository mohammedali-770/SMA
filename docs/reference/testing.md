...
**183 TypeScript test files declaring 2822 test blocks, plus 76 SQL suites.**
...
67 files, 948 declared test blocks.
...
| `apps/mobile/src/lib/orderSelectGrantParity.test.ts` | 5 | customer order select ↔ database grant parity |
