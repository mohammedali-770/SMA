...
**153 TypeScript test files declaring 2360 test blocks, plus 60 SQL suites.**
...
16 files, 467 declared test blocks.
...
| `supabase/functions/_shared/orderIntakeSyncWiring.test.ts` | 17 | order-intake — immediate POS sync, and no premature promise |
