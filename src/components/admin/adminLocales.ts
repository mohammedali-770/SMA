...
export const ADMIN_LOCALES = {
  en: {
    ...
    role: 'Session Role',
    push_on: 'Closure alerts are on for this device',
    push_off: 'Turn on closure alerts for this device',
    push_busy: 'Working…',
    push_denied: 'Notifications are blocked — allow them for this site in your browser settings',
    push_not_configured: 'Closure alerts are not configured yet',
    push_needs_install: 'Add this console to your Home Screen to receive alerts',
    push_needs_reinstall: 'Remove this console from your Home Screen and add it again to receive alerts',
    push_unsupported: 'This browser cannot receive alerts',
    push_failed: 'Could not change the alert setting',
  ...
  ar: {
    ...
    push_on: 'تنبيهات الإغلاق مفعّلة على هذا الجهاز',
    push_off: 'تفعيل تنبيهات الإغلاق على هذا الجهاز',
    push_busy: 'جارٍ التنفيذ…',
    push_denied: 'الإشعارات محظورة — اسمح بها لهذا الموقع من إعدادات المتصفح',
    push_not_configured: 'تنبيهات الإغلاق غير مهيأة بعد',
    push_needs_install: 'أضف لوحة التحكم إلى الشاشة الرئيسية لاستقبال التنبيهات',
    push_needs_reinstall: 'احذف لوحة التحكم من الشاشة الرئيسية وأضفها من جديد لاستقبال التنبيهات',
    push_unsupported: 'هذا المتصفح لا يدعم استقبال التنبيهات',
    push_failed: 'تعذّر تغيير إعداد التنبيهات',
